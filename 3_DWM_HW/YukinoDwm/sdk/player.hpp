...
public:
	...
	Player(int IndexID) {
		...
		this->m_iSpotted = Driver->RPM<bool>(this->entityController + schemas::client_dll::C_CSPlayerPawn::m_entitySpottedState + schemas::client_dll::EntitySpottedState_t::m_bSpotted);
